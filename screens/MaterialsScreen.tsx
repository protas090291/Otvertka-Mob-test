...
const MaterialsScreen: React.FC<MaterialsScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        <Header userRole={userRole} title="Материалы" />
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
          <Card variant="gradient">
            <Text style={styles.sectionTitle}>Материалы и склад</Text>
